...
public class UserController {
    ...
    @GetMapping("/device")
    public List<DeviceRoleDto> getDevices(@AuthenticationPrincipal UUID userId, @RequestParam(name = "role", required = false) DeviceRole role) {
        return userService.getUserDevices(userId, role);
    }
}
